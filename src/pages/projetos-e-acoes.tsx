          ...
          <div className="row">
            <div className="offset-3 col-6 mt-5 mb-0">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_prevestibular.jpg" alt="Pré-vestibular UniFavela" />
              </Card>
            </div>
          </div>
          <div className="row my-5">
            <div className="col-4 d-flex">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_uniletrinhas.jpg" alt="UniLetrinhas" />
              </Card>
            </div>
            <div className="col-4 d-flex">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_bolsacarolina.png" alt="Bolsa Carolina de Jesus" />
              </Card>
            </div>
            <div className="col-4 d-flex">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_brinqueleitura.jpg" alt="Brinque Leitura" />
              </Card>
            </div>
            <div className="col-4 d-flex">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_maredenatal.jpg" alt="Maré de Natal" />
              </Card>
            </div>
            <div className="col-4 d-flex">
              <Card icon={
                ...
                <StaticImage src="../images/projetos/unifavela_cicloformacao.jpg" alt="Ciclo de Formação UniFavela" />
              </Card>
            </div>
